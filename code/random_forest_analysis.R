...
write.csv(list_effects[[1]], "./data/feature_effects/rf/debt.csv")
write.csv(list_effects[[2]], "./data/feature_effects/rf/purpose.csv")
write.csv(list_effects[[3]], "./data/feature_effects/rf/pre.csv")
write.csv(list_effects[[4]], "./data/feature_effects/rf/amount.csv")
write.csv(list_effects[[5]], "./data/feature_effects/rf/lien.csv")
write.csv(list_effects[[6]], "./data/feature_effects/rf/co.csv")
write.csv(list_effects[[7]], "./data/feature_effects/rf/income.csv")
