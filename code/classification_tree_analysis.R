...
list_effects <- lapply(list_effects_old, function(x) cbind(x, Model = "Classification"))
...
write.csv(list_effects[[3]], "./data/feature_effects/tree/pre.csv")
write.csv(list_effects[[4]], "./data/feature_effects/tree/amount.csv")
write.csv(list_effects[[5]], "./data/feature_effects/tree/lien.csv")
write.csv(list_effects[[6]], "./data/feature_effects/tree/co.csv")
write.csv(list_effects[[7]], "./data/feature_effects/tree/income.csv")
write.csv(list_effects[[8]], "./data/feature_effects/tree/race.csv")
write.csv(list_effects[[9]], "./data/feature_effects/tree/eth.csv")
write.csv(list_effects[[10]], "./data/feature_effects/tree/sex.csv")
